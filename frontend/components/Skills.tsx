    ...
    <div className="py-20" id="skills">
      <div className="mb-18 mt-10 text-center">
        <h1 className="heading">
          Get to Know <span className="text-purple">Education & Skills</span>
        </h1>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full mt-10 px-4">
        <WobbleCard
        ...
        <WobbleCard containerClassName="col-span-1 min-h-[300px] bg-emerald-800">
          ...
          <ul className="mt-4 max-w-[26rem] text-left text-sm text-neutral-200 list-disc pl-5 space-y-1">
