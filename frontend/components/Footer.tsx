    ...
    <footer className="w-full pt-20 pb-20 " id="contact">
      ...
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw]">
          Ready to grow and{" "}
          <span className="text-purple-500">create impactful</span> web and
          mobile experiences?
        </h1>
        <p className="md:mt-10 my-5 text-center">
          Reach out to me today and let&apos;s discuss how I can help to achive
          your goals.
        </p>
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright © 2025 Kanchana Koralage. All rights reserved
        </p>
